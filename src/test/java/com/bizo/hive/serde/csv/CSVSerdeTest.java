...
public final class CSVSerdeTest {
  ...
  public void setup() throws Exception {
    new_props.put(Constants.LIST_COLUMNS, "a,b,c,d,e,f,g,h,i");
    new_props.put(Constants.LIST_COLUMN_TYPES, "string,string,int,bigint,float,double,timestamp,timestamp,void");
